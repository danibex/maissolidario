...
href="/curso/odontologia"
    ...
    `}>
        <div className="rounded-t-xl mx-0 px-0 mt-0 pt-0 mb-1 w-[365px] sm:w-[310px] md:w-[290px] lg:w-[320px]">
            <Image alt="" src={props.url} className="rounded-t-xl w-[365px] sm:w-[310px] md:w-[290px] lg:w-[320px]"/>
            <div className="text-2xl font-medium mt-4 flex justify-center items-center">{props.nome}</div>
        </div>
